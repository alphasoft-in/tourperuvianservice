    ...
    <div className="max-w-4xl mx-auto bg-white p-6 md:p-10 rounded-2xl shadow-xl font-['Montserrat']">
      ...
      <form action={formUrl} method="POST" className="space-y-8">
        ...
        <div className="flex justify-center mt-8">
          <button type="submit" className="bg-orange-700 hover:bg-orange-800 text-white font-bold py-3.5 px-10 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 uppercase tracking-wide">
            {t.submit}
          </button>
        </div>
