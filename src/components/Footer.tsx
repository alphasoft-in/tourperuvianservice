      ...
      >
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-6 md:p-8 relative z-10">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 xl:grid-cols-5 gap-4 md:gap-6 items-end">
            ...
            <button type="submit" className="xl:col-span-1 flex items-center justify-center bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 h-[46px] w-full mt-4 lg:mt-0 shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:-translate-y-0.5 cursor-pointer">
