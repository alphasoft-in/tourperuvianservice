...
export const packageData = [
  { id: 'huaraz', name: 'Huaraz', days: 4, nights: 3, image: '/img/paquetes_recomendados/huaraz.avif', category: 'destino', isFeatured: true, locationType: 'nacional' },
          ...
          {filteredData.map((pkg) => (
            ...
            >
              ...
              <div className="p-4 md:p-8 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-center text-slate-600 mb-4 md:mb-6 bg-slate-50 rounded-xl md:rounded-2xl p-3 md:p-4 border border-slate-100">
                ...
                <div className="flex flex-col gap-2.5 mt-2">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center w-full py-2 md:py-2.5 text-[10px] md:text-xs font-bold text-white rounded-full bg-gradient-to-r from-green-500 to-emerald-600 hover:shadow-lg hover:shadow-green-500/40 hover:-translate-y-0.5 transition-all duration-300 uppercase tracking-wider"
                    aria-label={lang === 'es' ? `Consultar por WhatsApp sobre ${pkg.name}` : `Inquire via WhatsApp about ${pkg.name}`}
                  >
